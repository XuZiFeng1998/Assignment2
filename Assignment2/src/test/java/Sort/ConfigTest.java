...
import utils.PrivateMethodTester;
...
public class ConfigTest {
    ...
    public static final String INSTRUMENTING = utils.InstrumentedHelper.INSTRUMENTING;
    public static final String INVERSIONS = utils.InstrumentedHelper.INVERSIONS;
    public static final String SEED = "seed";
    public static final String CUTOFF = "cutoff";
    public static final String SWAPS = utils.InstrumentedHelper.SWAPS;
    public static final String COMPARES = utils.InstrumentedHelper.COMPARES;
    public static final String COPIES = utils.InstrumentedHelper.COPIES;
