...
import Sort.Config;
import Sort.LazyLogger;
import Sort.StatPack;

import java.util.Random;

import static Sort.Utilities.formatWhole;
...
public class InstrumentedHelper<X extends Comparable<X>> extends BaseHelper<X> {
    ...
    final static Sort.LazyLogger logger = new LazyLogger(InstrumentedHelper.class);
